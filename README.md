...
> **Nota:** o Gerador de TRM + Débitos corre a partir de um portátil pessoal, exposto via Tailscale Funnel (porta 8443), por isso a sua disponibilidade depende de esse portátil estar ligado e com ligação à rede.
